...
scene = [
    SimpleCylinder(Vec3(1.0f0, 5.0f0, 5.0f0), 1.0f0, Vec3(0.0f0, 1.0f0, 0.0f0),
                   color = Vec3(1.0f0, 0.0f0, 0.0f0)),
    CheckeredCylinder(Vec3(-1.0f0, 1.0f0, 2.0f0), 0.6f0, Vec3(0.0f0, 1.0f0, 0.0f0),
                      color1 = rgb(1.0f0, 1.0f0, 0.0f0),
                      color2 = rgb(1.0f0, 0.0f0, 0.0f0)),
    CheckeredSphere(Vec3(0.0f0, -99999.5f0, 0.0f0), 99999.0f0,
                    color1 = rgb(1.0f0), color2 = rgb(0.0f0), reflection = 0.25f0)
    ]
