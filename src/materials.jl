...
diffusecolor(c::PlainColor, pt::Vec3, obj) = c.color
...
# NOTE: This needs to be deprecated in favor of texture
...
function diffusecolor(c::CheckeredSurface, pt::Vec3, obj)
...
diffusecolor(m::Material, pt::Vec3, obj) = diffusecolor(m.color, pt, obj)
